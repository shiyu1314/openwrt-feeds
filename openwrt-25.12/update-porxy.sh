...
rm -rf openwrt_helloworld/{sing-box,luci-app-homeproxy,luci-app-nikki,nikki,v2ray-geodata,luci-app-openclash,luci-app-ssr-plus,luci-app-daed,daed,dae,vmlinux-btf,luci-app-dae}
...
rm -rf img
ls -d */ | xargs -n 1 basename | grep "^luci-app" | while read pkg; do
