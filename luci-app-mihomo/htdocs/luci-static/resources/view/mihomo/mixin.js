...
return view.extend({
    ...
    render: function (data) {
        ...
        o.rmempty = false;
        o.value('https://gh.api.99988866.xyz/https://github.com/Zephyruso/zashboard/archive/refs/heads/gh-pages.zip', 'Zashboard');
        o.value('https://gh.api.99988866.xyz/https://github.com/MetaCubeX/metacubexd/archive/refs/heads/gh-pages.zip', 'MetaCubeXD');
        o.value('https://gh.api.99988866.xyz/https://github.com/MetaCubeX/Yacd-meta/archive/refs/heads/gh-pages.zip', 'YACD');
        o.value('https://gh.api.99988866.xyz/https://github.com/MetaCubeX/Razord-meta/archive/refs/heads/gh-pages.zip', 'Razord');
