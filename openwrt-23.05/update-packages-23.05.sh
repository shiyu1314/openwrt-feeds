...
rm -rf openwrt_pkgs/{bash-completion,luci-app-ota,fw_download_tool,luci-app-adguardhome,luci-app-usb-printer}
...
# aria2 & ariaNG
git clone https://github.com/sbwml/ariang-nginx ariang-nginx
sed -i '12d' ariang-nginx/luci-app-aria2/root/etc/uci-defaults/40_luci-aria2
...
sed -i "s/Basic Setting/Basic Settings/" alist/luci-app-alist/po/zh_Hans/alist.po
rm -rf alist/{.git,LICENSE,README.md}
mv alist/* ./
