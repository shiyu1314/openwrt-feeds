...
git clone https://github.com/immortalwrt/immortalwrt imm-openwrt-23.05 -b openwrt-23.05 --depth 1
git clone https://github.com/sbwml/autocore-arm autocore-arm -b openwrt-23.05 --depth 1

rm -rf autocore-arm/.git
sed -i 's/ + '\'' \x27 + luciversion\.revision//g' autocore-arm/files/generic/10_system.js
...
rm -rf imm-openwrt-23.05/package/emortal/{default-settings,autocore,cpufreq}
mv imm-openwrt-23.05/package/emortal/* ./


rm -rf openwrt-master openwrt-23.05 luci-23.05 imm-openwrt-23.05
